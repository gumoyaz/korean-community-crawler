...
- [ ] **(1순위) 키워드 영역 통합.** 상단 급상승 띠, 급상승 키워드, 인기 단어 구름이 같은 단어 빈도 데이터를 세 번 보여줘서 겹친다. 단어 하나만 떠서 왜 뜨는지도 알 수 없다. 하나의 더 유용한 형태로 합친다. '싶은·사귀고·보고' 같은 서술어와 게시판명('야갤')도 아직 키워드에 섞인다(09-24 확인).
