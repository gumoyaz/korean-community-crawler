...
4. **형식**: `## 섹션 제목` 으로 주제별 구분. 섹션 수 5-8개. 섹션당 **3-5문장**.
5. **균등 서술 필수**: 첫 섹션과 마지막 섹션의 분량이 비슷해야 함. 앞 섹션에만 집중하고 뒷 섹션을 짧게 쓰는 것 절대 금지.
6. 커뮤니티 이름 나열 금지. 내용 위주 서술.
7. 🔥급상승 표시된 글은 섹션 제목에 "🔥" 표시.
